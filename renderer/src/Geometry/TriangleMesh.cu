...
RT_PROGRAM void mesh_intersect(int primIdx)
{
    ...
    if(intersect_triangle(ray, p0, p1, p2, n, t, beta, gamma)
      ||   intersect_triangle(ray, p0, p2, p1, n, t, beta, gamma)
      ||   intersect_triangle(ray, p1, p2, p0, n, t, beta, gamma)
      ||   intersect_triangle(ray, p1, p0, p2, n, t, beta, gamma)
      ||   intersect_triangle(ray, p2, p0, p1, n, t, beta, gamma)
      ||   intersect_triangle(ray, p2, p1, p0, n, t, beta, gamma))
    {
        if (false) {//normalBuffer.size() > 0) {
        ...
        if(rtPotentialIntersection( t ))
        {
            if ( normalBuffer.size() == 0 ) {
                shadingNormal = myshadingNormal;//normalize( n );
            } else {
