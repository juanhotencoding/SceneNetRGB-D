...
optix::Geometry AABInstance::getOptixGeometry( optix::Context & context)
{
    ...
    {
        m_programBoundingBox = context->createProgramFromPTXFile(ptxpath() + "AAB.cu.ptx", "boundingBox");
        m_programIntersection = context->createProgramFromPTXFile(ptxpath() + "AAB.cu.ptx", "intersect");
